<div class="main-container">
	...
	</form><div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		        <div class="modal-dialog" role="document">
		          <div class="modal-content">
		            ...
		            <div class="modal-footer">
		            	<?php if($stats==1){
		            		$link = base_url();
		            		echo "<a type='button' class='btn btn-primary' href='$link'; >Login</a>";
	
		            }else{
		            	$link = base_url('register');
		            	echo "<a type='button' class='btn btn-danger' href='$link' >Retry</a>";
		        	}?>
		            </div>
		          </div>
		        </div>
